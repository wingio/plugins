...
public class ItemCard extends MaterialCardView {
    ...
    public ItemCard(Context ctx) {
        ...
        icon.setLayoutParams(new LayoutParams(Utils.dpToPx(38), Utils.dpToPx(38)));
        root.addView(icon);

        name = new TextView(ctx);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(Utils.dpToPx(110), LinearLayout.LayoutParams.WRAP_CONTENT);
        ...
        LinearLayout.LayoutParams editParams = new LinearLayout.LayoutParams(Utils.dpToPx(103), Utils.dpToPx(48));
        ...
        LinearLayout.LayoutParams clearParams = new LinearLayout.LayoutParams(Utils.dpToPx(40), Utils.dpToPx(40));
