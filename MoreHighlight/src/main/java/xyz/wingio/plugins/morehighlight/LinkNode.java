...
public class LinkNode<MessageRenderContext> extends Node<MessageRenderContext> {
  ...
  public LinkNode(String content, String url){
    super();
  ...
  public void render(SpannableStringBuilder builder, MessageRenderContext renderContext) {
    Object clickableSpan = new ClickableSpan(Integer.valueOf(ColorCompat.getThemedColor(Utils.getAppContext(), R.b.colorTextLink)), false, v -> {return Unit.a;}, v-> {Utils.launchUrl(url); return Unit.a;});
