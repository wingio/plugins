    ...
    public void start(Context context) throws Throwable {
        ...
        patcher.patch(WidgetUrlActions.class, "onViewCreated", new Class<?>[] { View.class, Bundle.class }, new PinePatchFn(callFrame -> {
            ...
            option.setOnClickListener(e -> {
                ...
                WidgetChangeLog.Companion.launch(ctx, "2021-08-05", "1", "https://media.discordapp.net/attachments/719794226673614879/872734785901047849/20210802_210912.jpg", body);
            });
